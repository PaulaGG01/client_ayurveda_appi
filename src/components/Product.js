                ...
                <div className="py-10 lg:pt-6 lg:pb-16 lg:col-start-1 lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8">
                  <div>
                    ...
                    <div className="space-y-6">
                      <p className="text-base text-gray-900">Producto ayurvédico orgánico para tu bienestar integral.  </p>
                    </div>
                  </div>

                  <div className="mt-10">
                    <h3 className="text-sm font-medium text-gray-900">Este producto es:</h3>

                    <div className="mt-4">
                      <ul role="list" className="pl-4 list-disc text-sm space-y-2">
                        <li className="text-gray-400"><span className="text-gray-600">Orgánico</span></li>

                        <li className="text-gray-400"><span className="text-gray-600">Natural</span></li>

                        <li className="text-gray-400"><span className="text-gray-600">Cruelty free</span></li>

                        <li className="text-gray-400"><span className="text-gray-600">Sustentable</span></li>
                      </ul>
                    </div>
                  </div>

                  <div className="mt-10">
                    <h2 className="text-sm font-medium text-gray-900">Despacho</h2>

                    <div className="mt-4 space-y-6">
                      <p className="text-sm text-gray-600">Despacho gratis en 48 horas para comunas de la Región Metropolitana. Consulta por costos de envío y tiempo de despacho para otras regiones.</p>
                    </div>
                  </div>
                </div>
              </div>
