...
import BackgroundJumbotron from './../assets/images.jpg'
              ...
              <div className="relative shadow-xl sm:rounded-2xl sm:overflow-hidden">
                ...
                <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                  <h1 className="text-center text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl">
                    <span className="block text-white">Planet Ayurveda</span>
                    <span className="block text-white">para tu bienestar integral</span>
                  </h1>
                  <p className="mt-6 max-w-lg mx-auto text-center text-xl text-white sm:max-w-3xl">
                  El ayurveda o medicina ayurvédica, es un sistema de estilo de vida saludable milenario que hace hincapié en la prevención y en el uso de remedios herbarios naturales. Contamos una gran cantidad de productos que te ayudarán a mejorar tu estilo de vida.
                  </p>
